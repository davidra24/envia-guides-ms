...
import { formatMoney, totalGuide } from '../../utilities/calculate.utility';
...
export const createGuideUseCase = async ({
  sourceGuide,
  guideCreation
}: CreateGuideProps) => {
  ...
  const {
    ...
    guide_person: { origin_city, destination_city, destination_regional },
    sender: {
