...
CREATE VIEW IF NOT EXISTS VIEW_GUIDE_PERSON AS SELECT g.id_guide, g.status_guide, g.date_admission, g.notes_guide, g.content_guide, g.units_in_guide, g.weight_in_guide, g.volume_in_guide, g.weight_payment_guide, g.declared_value_guide, g.service_value_guide, g.freight_guide, g.other_cost_guide,
	gp.origin_city, gp.destination_city, gp.destination_regional, gp.address_addressee as address_addressee_in_guide,	
